...
export default function MainAside() {
  return (
    <aside className='cardItem basis-1/5 h-[calc(100vh-3rem-67.5px)] relative min-h-[500px] max-lg:hidden'>
      <Image placeholder='blur' blurDataURL={'/headshot_1_1.jpg'} className='w-2/3 mx-auto mt-2 rounded-full border-solid border-2 border-mainBG' src={'/headshot_1_1.jpg'} width={200} height={200} alt='Pavel'/>
