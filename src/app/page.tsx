      ...
      <ul className='flex max-sm:flex-col wrap justify-between -m-1 items-center'>
        <li className='cardItem hover:bg-accent-300 m-1 max-sm:basis-full basis-1/3 max-sm:w-full max-sm:max-w-[350px] max-sm:mx-auto'>
          <Link href={'/rover/curiosity'}>
            <Image className='rover-button' src={'/curiosity_rover.jpg'} width={200} height={200} alt='Curiosity'/>
            <h3>Curiosity</h3>
          </Link>
        </li>
        <li className='cardItem hover:bg-accent-300 m-1 max-sm:basis-full basis-1/3 max-sm:w-full max-sm:max-w-[350px] max-sm:mx-auto'>
          <Link href={'/rover/opportunity'}>
            <Image className='rover-button' src={'/opportunity_rover.jpg'} width={200} height={200} alt='Opportunity'/>
            <h3>Opportunity</h3>
          </Link>
        </li>
        <li className='cardItem hover:bg-accent-300 m-1 max-sm:basis-full basis-1/3 max-sm:w-full max-sm:max-w-[350px] max-sm:mx-auto'>
          <Link href={'/rover/spirit'}>
            <Image className='rover-button' src={'/spirit_rover.jpg'} width={200} height={200} alt='Spirit'/>
            <h3>Spirit</h3>
          </Link>
        </li>
      </ul>
